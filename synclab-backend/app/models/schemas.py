...
class SessionResponse(BaseModel):
    """세션 결과"""
    status: str
    session: Dict[str, Any]  # sessionInfo 규격
...
class HomeDataResponse(BaseModel):
    ...
    history: List[Dict[str, Any]]  # SessionInfo 리스트
    videos: Optional[Dict[str, List[Any]]] = None  # 세션별 영상
